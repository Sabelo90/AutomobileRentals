...
namespace AutomobileRentalsCore.Services
{
    ...
    {
        private readonly IPersonResource _resource;
        public PersonService(IPersonResource personResource)
        {
            _resource = personResource;
        }
        ...
        public async Task<PersonModel> DeleteAsync(PersonModel model)
        {
            try
            {
                //todo.. Aunthetication and Authorisation
                ...
                if (!canDelete)
                {
                    ...
                    throw new Exception($"Delete disallowed for person with id: {model.per_id}");
                }
        ...
        public async Task<PersonModel> PostAync(PersonModel model)
        {
            try
            {
                //todo.. Aunthetication and Authorisation 
        ...
        public async Task<PersonModel> PutAsync(PersonModel model)
        {
            try
            {
                //todo.. Aunthetication and Authorisation 
                ...
                {
                    //todo.. find a better way to implement this
                    throw new Exception($"Update disallowed for model with id: {model.per_id}");
                }
        ...
        public Task<bool> onDeleteListCompletedAsync(PersonModel[] models)
        {
